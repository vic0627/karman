...
export type MimeType = "text/plain" | "application/javascript" | "application/json" | "text/html" | "application/xml" | "application/pdf" | "application/x-www-form-urlencoded" | "multipart/form-data" | "image/jpeg" | "image/png" | "image/gif" | "audio/mpeg" | "audio/wav" | "video/mp4" | "video/quicktime";
...
export interface ApiConfig<D, T extends ReqStrategyTypes, P extends PayloadDef> extends RequestConfig<T>, SyncHooks, AsyncHooks, UtilConfig, CacheConfig {
    endpoint?: string;
    method?: HttpMethod;
    payloadDef?: P;
    dto?: D;
...
export type XhrHooksHandler<D, T extends ReqStrategyTypes> = (e: ProgressEvent | Event, config: HttpConfig<T>, xhr: XMLHttpRequest, executer: PromiseExecutor<D>) => void;
...
//# sourceMappingURL=http.type.d.ts.map