...
let Xhr = class Xhr {
  ...
  request(payload, config) {
    ...
    const requestExecutor = onRequest => {
...
let ApiFactory = class ApiFactory {
  ...
  xhr;
  cachePipe;
  constructor(template, typeCheck, pathResolver, validationEngine, xhr, cachePipe) {
    this.template = template;
    this.typeCheck = typeCheck;
  ...
  createAPI(apiConfig) {
    ...
    function finalAPI(payload, runtimeOptions) {
      ...
      let _payload = requestBody;
      if (_af.typeCheck.isFunction(onBeforeRequest)) {
        _payload = onBeforeRequest.call(this, requestURL, requestBody);
      }
...
ApiFactory = __decorate([Injectable(), __metadata("design:paramtypes", [Template, TypeCheck, PathResolver, ValidationEngine$1, Xhr$1, CachePipe$1])], ApiFactory);
...
let KarmanFactory = class KarmanFactory {
  typeCheck;
  constructor(typeCheck) {
    this.typeCheck = typeCheck;
  }
...
KarmanFactory = __decorate([Injectable(), __metadata("design:paramtypes", [TypeCheck])], KarmanFactory);
var KarmanFactory$1 = KarmanFactory;
...
let LayerBuilder = class LayerBuilder {
  ...
  pathResolver;
  karmanFactory;
  constructor(typeCheck, scheduledTask, pathResolver, karmanFactory) {
    this.typeCheck = typeCheck;
    this.scheduledTask = scheduledTask;
    this.pathResolver = pathResolver;
    this.karmanFactory = karmanFactory;
  }
  configure(k) {
    const {
      baseURL,
...
LayerBuilder = __decorate([Injectable(), __metadata("design:paramtypes", [TypeCheck, ScheduledTask$1, PathResolver, KarmanFactory$1])], LayerBuilder);
...
default_1 = __decorate([IOCContainer({
  imports: [CachePipe$1, ApiFactory$1, KarmanFactory$1, LayerBuilder$1, Xhr$1, ScheduledTask$1, FunctionalValidator$1, ParameterDescriptorValidator$1, RegExpValidator, TypeValidator$1, ValidationEngine$1],
...
exports.defineCustomValidator = defineCustomValidator;
exports.defineIntersectionRules = defineIntersectionRules;
exports.defineKarman = defineKarman;
exports.defineUnionRules = defineUnionRules;
