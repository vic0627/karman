...
export default abstract class RequestPipe {
     ...
     */
    abstract chain<D, T extends ReqStrategyTypes>(requestDetail: PipeDetail<D, T>, ...args: any[]): RequestExecutor<SelectRequestStrategy<T, D>>;
}
//# sourceMappingURL=request-pipe.abstract.d.ts.map