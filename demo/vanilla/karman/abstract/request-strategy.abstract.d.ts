...
export default abstract class RequestStrategy {
    abstract request<D, T extends ReqStrategyTypes>(payload: HttpBody, config: HttpConfig<T>): RequestDetail<SelectRequestStrategy<T, D>, T>;
}
//# sourceMappingURL=request-strategy.abstract.d.ts.map